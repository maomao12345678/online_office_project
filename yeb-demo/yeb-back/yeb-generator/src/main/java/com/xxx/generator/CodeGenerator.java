 ...
 * 可以自动生成代码
 * 根据Mybatis-plus自动生产与数据库对应的crud的结构
 * @author zhoubin
 * @since 1.0.0
 */
...
public class CodeGenerator {
    public static void main(String[] args) {
        ...
        dataSourceConfig.setPassword("ou83190760");
        dataSourceConfig.setUrl("jdbc:mysql://localhost:3306/newYeb?useUnicode=true&characterEncoding=UTF-8");
        autoGenerator.setDataSource(dataSourceConfig);
        GlobalConfig globalConfig = new GlobalConfig();
        globalConfig.setOpen(true); // 代码生成后打开目录
        globalConfig.setOutputDir(System.getProperty("user.dir")+"/src/main/java");
        globalConfig.setAuthor("maomao");
